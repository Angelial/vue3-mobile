<template>
  <div class="protocol">
    ...
    <p class="content">欢迎您使用MojoMojo软件及相关服务！</p>
    <p class="content">
      厦门逆为网络科技有限公司（含其关联公司，以下称“逆为”或“我们”）为MojoMojo
      app（以下称“本站”或“MojoMojo”）的实际开发者和运营者。“MojoMojo”是一款专注放松、减压睡眠的身心健康app，用户可以跟随“MojoMojo”的声音场景进行专注、放松、减压或助眠活动。本服务条款构成我们与本站用户（以下称“用户”或“您”）之间就MojoMojoapp提供的上述服务等事宜订立的契约，请仔细阅读本服务条款。
    </p>
    <p class="content">
      您访问本站，下载MojoMojoapp并注册成为本站用户后，则即表示您同意接受本服务条款的约束，而本服务条款即构成对双方具有约束力的法律文件。
    </p>
    ...
    <p class="content">
      ...
      除非您接受本协议所有条款，否则您无权注册、登录或使用本协议所涉服务。您的注册、登录、使用等行为将视为对本协议的接受，并同意接受本协议各项条款的约束，本协议将构成您与厦门逆为网络科技有限公司（及关联方）与其主办的MojoMojoAPP合称为“MojoMojo”）之间直接有约束力的法律文件。
    </p>
    <p class="content">
